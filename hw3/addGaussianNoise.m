...
%     s = 500;
    noiseMat = s * randn(size(im));%randn will get values normaly disterbuted with std 1
    noisyIm = im + noiseMat;%add a random value which is chosen from a Gaussian distribution of std s
